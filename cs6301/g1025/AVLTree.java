...
public class AVLTree<T extends Comparable<? super T>> extends BST<T> {
	 ...
	 * @return void
	 */
	public void setHeight(Entry<T> t) {
	 ...
	 * @return void
	 */
	void linkChild(Entry<T> head, Entry<T> child) {
	 ...
	 * ROTATIONS
	 */
	Entry<T> rotateRight(Entry<T> head) {
	...
	Entry<T> rotateLeft(Entry<T> head) {
